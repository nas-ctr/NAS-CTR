...
from codes.utils import EarlyStop
...
def train_search(train_queue, valid_queue, model, optimizer, arch_optimizer, args, log_interval=100):
    ...
    for i, (dense_train, sparse_train, labels_train) in enumerate(tt):
        ...
        loss_valid = model.step(dense_valid, sparse_valid, labels_valid, arch_optimizer)
...
def train(train_queue, val_queue, model, optimizer, args, model_path=None, patience=10, scheduler=None, log_interval=100, logger=None, show_log=True):
